...
/**
 * Exposing native Float32 DSP (clarity, EQ, volume boost, peak protection) in
 * front of ExoPlayer's DefaultAudioSink. Media3's DefaultAudioSink owns hardware
 * output and frame-accurate clock synchronization across all track transitions,
 * seeks and device routing.
 */
